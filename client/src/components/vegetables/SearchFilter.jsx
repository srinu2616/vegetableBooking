            ...
            <div className="lg:hidden mb-6 flex space-x-4">
                <div className="relative flex-grow">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-white text-gray-900 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all"
                    />
                </div>
                <button
                ...
                <div className="space-y-8">
                    ...
                    <div className="hidden lg:block relative">
                        ...
                        <input
                            ...
                            value={filters.keyword}
                            onChange={handleSearchChange}
                            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none text-sm bg-white text-gray-900"
                        />
                    </div>
