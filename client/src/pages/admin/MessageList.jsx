            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none w-full md:w-80 shadow-sm transition-all"
                    />
                </div>
            </div>
                    ...
                    <AnimatePresence mode="wait">
                        {selectedMessage ? (
                            <motion.div
                                ...
                                className="bg-white rounded-3xl border border-gray-100 shadow-premium overflow-hidden h-full flex flex-col"
                            >
                                <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="px-4 py-2 bg-white rounded-xl border border-gray-200 text-xs font-bold text-gray-600 flex items-center gap-2">
