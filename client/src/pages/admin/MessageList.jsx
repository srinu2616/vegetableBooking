    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-serif font-bold text-gray-900">Customer Messages</h1>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-primary-500 outline-none w-full md:w-80 shadow-sm transition-all"
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-1 space-y-4 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
                    {filteredMessages.length === 0 ? (
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 text-center transition-colors">
                    ...
                    <AnimatePresence mode="wait">
                        {selectedMessage ? (
                            <motion.div
                                ...
                                className="bg-white rounded-3xl border border-gray-100 shadow-premium overflow-hidden h-full flex flex-col transition-colors"
                            >
                                <div className="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="px-4 py-2 bg-white rounded-xl border border-gray-200 text-xs font-bold text-gray-600 flex items-center gap-2 shadow-sm">
                                ...
                                <div className="p-8 flex-1 overflow-y-auto">
                                    ...
                                    <div className="space-y-4">
                                        <span className="text-xs uppercase font-extrabold text-gray-400 tracking-wider">Message</span>
                                    ...
                                    {replying && (
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                className="w-full px-4 py-2.5 bg-white border border-gray-200 text-gray-900 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none shadow-sm transition-all"
                                                placeholder="Subject"
                                                required
                                            />
                                            <textarea
                                                ...
                                                className="w-full px-4 py-3 bg-white border border-gray-200 text-gray-900 rounded-2xl focus:ring-2 focus:ring-primary-500 outline-none shadow-sm transition-all h-32 resize-none"
                            ...
                            <div className="bg-white rounded-3xl border border-gray-100 border-dashed h-full flex items-center justify-center p-12 text-center transition-colors">
                                <div>
                                    ...
                                    <p className="text-gray-500 max-w-xs mx-auto">Choose a message from the list on the left to view its full details and respond.</p>
                                </div>
                            </div>
                        )}
                    </AnimatePresence>
